...
# --- MÁGICA DE ORDENAÇÃO GEOMÉTRICA DOS GRÁFICOS ---
# 1. Agrupar classes e ordernar do maior para o menor patrimônio real líquido
...
# 2. Organizar os ativos agrupados por classe e por tamanho interno (mantém PKIN11 e os blocos sem se misturar)
...
# 3. Tabela Detalhe estruturada em ordem decrescente padrão de patrimônio
...
with aba_dash:
    ...
    with col1:
        ...
        # Rotação 90 + Sentido horário + Desativar sort interno: 
        # Faz o maior bloco iniciar nas 12h e preencher o Quadrante Superior Esquerdo (2º Quadrante)
    ...
    with col2:
        ...
        # Mantém a mesma simetria geométrica exata para o gráfico de ativos
